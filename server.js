...
var jwtOptions = { jwtFromRequest: ExtractJwt.fromAuthHeaderWithScheme("jwt") };
jwtOptions.secretOrKey = process.env.JWT_SECRET;
var strategy = new JwtStrategy(jwtOptions, (jwt_payload, next) => {
    jwt_payload ? next(null, { _id: jwt_payload._id, userName: jwt_payload.userName }) : next(null, false);
});
